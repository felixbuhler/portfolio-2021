...
<head>
    <meta charset="utf-8">
    <title>Felix Buhler — Imprint & Privacy</title>
    <meta name="author" content="Felix Buhler">
    <meta name="description" content="I'm Felix Buhler, multi-disciplinary designer living and working in Kreuzberg, Berlin.">
...
<body onload="startTime();">
    <header padding-border no-border>
        <header-column><a href="/" style="color: inherit; text-decoration: none;">Back home</a></header-column>
        <header-column>
            <div class="color-change">
                <div>👹</div>
            </div>
        </header-column>
        <header-column align-right><span id="time"></span></header-column>
        <div class="clear"></div>
    </header>
    <!-- Main Content -->
    <main imprint>
        <!-- Intro Text -->
        <content-panel padding-border>
            <!-- Impressum -->
            <h2>Impressum</h2>
            <text> Felix Buhler
                <br>Reichenberger Str. 140
                <br>10999 Berlin
                <br> Telefon: 0176 64796213
                <br>E-Mail: <a href="mailto:hi@felix-buhler.de">hi@felix-buhler.de</a>
                <br> </text>
        </content-panel>
        <content-panel padding-border>
            <!-- Disclaimer -->
            <h2>Disclaimer – rechtliche Hinweise</h2>
            <text imprint> <strong>§ 1 Warnhinweis zu Inhalten</strong> Die kostenlosen und frei zugänglichen Inhalte dieser Webseite wurden mit größtmöglicher Sorgfalt erstellt. Der Anbieter dieser Webseite übernimmt jedoch keine Gewähr für die Richtigkeit und Aktualität der bereitgestellten kostenlosen und frei zugänglichen journalistischen Ratgeber und Nachrichten. Namentlich gekennzeichnete Beiträge geben die Meinung des jeweiligen Autors und nicht immer die Meinung des Anbieters wieder. Allein durch den Aufruf der kostenlosen und frei zugänglichen Inhalte kommt keinerlei Vertragsverhältnis zwischen dem Nutzer und dem Anbieter zustande, insoweit fehlt es am Rechtsbindungswillen des Anbieters.
                <br>
                <br> <strong>§ 2 Externe Links</strong> Diese Website enthält Verknüpfungen zu Websites Dritter ("externe Links"). Diese Websites unterliegen der Haftung der jeweiligen Betreiber. Der Anbieter hat bei der erstmaligen Verknüpfung der externen Links die fremden Inhalte daraufhin überprüft, ob etwaige Rechtsverstöße bestehen. Zu dem Zeitpunkt waren keine Rechtsverstöße ersichtlich. Der Anbieter hat keinerlei Einfluss auf die aktuelle und zukünftige Gestaltung und auf die Inhalte der verknüpften Seiten. Das Setzen von externen Links bedeutet nicht, dass sich der Anbieter die hinter dem Verweis oder Link liegenden Inhalte zu Eigen macht. Eine ständige Kontrolle der externen Links ist für den Anbieter ohne konkrete Hinweise auf Rechtsverstöße nicht zumutbar. Bei Kenntnis von Rechtsverstößen werden jedoch derartige externe Links unverzüglich gelöscht.
                <br>
                <br> <strong>§ 3 Urheber- und Leistungsschutzrechte</strong> Die auf dieser Website veröffentlichten Inhalte unterliegen dem deutschen Urheber- und Leistungsschutzrecht. Jede vom deutschen Urheber- und Leistungsschutzrecht nicht zugelassene Verwertung bedarf der vorherigen schriftlichen Zustimmung des Anbieters oder jeweiligen Rechteinhabers. Dies gilt insbesondere für Vervielfältigung, Bearbeitung, Übersetzung, Einspeicherung, Verarbeitung bzw. Wiedergabe von Inhalten in Datenbanken oder anderen elektronischen Medien und Systemen. Inhalte und Rechte Dritter sind dabei als solche gekennzeichnet. Die unerlaubte Vervielfältigung oder Weitergabe einzelner Inhalte oder kompletter Seiten ist nicht gestattet und strafbar. Lediglich die Herstellung von Kopien und Downloads für den persönlichen, privaten und nicht kommerziellen Gebrauch ist erlaubt.
                <br>
                <br> Die Darstellung dieser Website in fremden Frames ist nur mit schriftlicher Erlaubnis zulässig.
                <br>
                <br> <strong>§ 4 Besondere Nutzungsbedingungen</strong> Soweit besondere Bedingungen für einzelne Nutzungen dieser Website von den vorgenannten Paragraphen abweichen, wird an entsprechender Stelle ausdrücklich darauf hingewiesen. In diesem Falle gelten im jeweiligen Einzelfall die besonderen Nutzungsbedingungen.
                <br>
                <br>Quelle: <a href="https://www.juraforum.de/impressum-generator/">Impressum Muster von JuraForum.de</a> </text>
        </content-panel>
        <content-panel padding-border>
            <!-- Datenschutz -->
            <h2>Datenschutz</h2>
            <text imprint> Wir informieren Sie nachfolgend gemäß den gesetzlichen Vorgaben des Datenschutzrechts (insb. gemäß BDSG n.F. und der europäischen Datenschutz-Grundverordnung ‚DS-GVO‘) über die Art, den Umfang und Zweck der Verarbeitung personenbezogener Daten durch unser Unternehmen.&nbsp;Diese Datenschutzerklärung gilt auch für unsere Websites und Sozial-Media-Profile. Bezüglich der Definition von Begriffen wie etwa „personenbezogene Daten“ oder „Verarbeitung“ verweisen wir auf Art. 4 DS-GVO.
                <br>
                <br><strong>Name und Kontaktdaten des / der Verantwortlichen</strong> Unser/e Verantwortliche/r (nachfolgend „Verantwortlicher“) i.S.d. Art. 4 Zif. 7 DS-GVO ist:
                <br>
                <br>Felix Buhler
                <br>Reichenberger Str. 140
                <br>10999 Berlin, Deutschland
                <br>E-Mail-Adresse: hi@felix-buhler.de
                <br>
                <br><strong>Datenarten, Zwecke der Verarbeitung und Kategorien betroffener Personen</strong> Nachfolgend informieren wir Sie über Art, Umfang und Zweck der Erhebung, Verarbeitung und Nutzung personenbezogener Daten.
                <ol style="list-style: none;">
                    <li>1. Arten der Daten, die wir verarbeiten</li>
                    <li>2. Zwecke der Verarbeitung nach Art. 13 Abs. 1 c) DS-GVO</li>
                    <li>3. Kategorien der betroffenen Personen nach Art. 13 Abs. 1 e) DS-GVO</li>
                </ol>
                <br> Die betroffenen Personen werden zusammenfassend als „Nutzer“ bezeichnet.<br>
                <br> <strong>Rechtsgrundlagen der Verarbeitung personenbezogener Daten</strong>
                <p>Nachfolgend Informieren wir Sie über die Rechtsgrundlagen der Verarbeitung personenbezogener Daten:</p>
                <ul style="margin:0px 10px; padding:15px;">
                ...
                <br> <strong>Weitergabe personenbezogener Daten an Dritte und Auftragsverarbeiter</strong>
                ...
                <br> <strong>Datenübermittlung in Drittstaaten</strong>
                ...
                <br> <strong>Löschung von Daten und Speicherdauer</strong>
                ...
                <br> <strong>Bestehen einer automatisierten Entscheidungsfindung</strong>
                <p>Wir setzen keine automatische Entscheidungsfindung oder ein Profiling ein.</p>
                <br> <strong>Bereitstellung unserer Website und Erstellung von Logfiles</strong>
                <ol style="margin:0px 10px; padding:15px;">
                    <li>Wenn Sie unsere Webseite lediglich informatorisch nutzen (also keine Registrierung und auch keine anderweitige Übermittlung von Informationen), erheben wir nur die personenbezogenen Daten, die Ihr Browser an unseren Server übermittelt. Wenn Sie unsere Website betrachten möchten, erheben wir die folgenden Daten: • IP-Adresse;
                        ...
                        <br>
                        <br> </li>
                    <li>Diese Daten dienen dem Zweck der nutzerfreundlichen, funktionsfähigen und sicheren Auslieferung unserer Website an Sie mit Funktionen und Inhalten sowie deren Optimierung und statistischen Auswertung.
                        <br>
                        <br> </li>
                    <li>Rechtsgrundlage hierfür ist unser in den obigen Zwecken auch liegendes berechtigtes Interesse an der Datenverarbeitung nach Art. 6 Abs. 1 S.1 lit. f) DS-GVO.
                        <br>
                        <br> </li>
                    <li>Wir speichern aus Sicherheitsgründen diese Daten in Server-Logfiles für die Speicherdauer von Tagen. Nach Ablauf dieser Frist werden diese automatisch gelöscht, es sei denn wir benötigen deren Aufbewahrung zu Beweiszwecken bei Angriffen auf die Serverinfrastruktur oder anderen Rechtsverletzungen.
                        <br> </li>
                </ol>
                <br> <strong>Präsenz in sozialen Medien</strong>
                <ol style="margin:0px 10px; padding:15px;">
                    <li>Wir unterhalten in sozialen Medien Profile bzw. Fanpages, um mit den dort angeschlossenen und registrierten Nutzern zu kommunizieren und um über unsere Produkte, Angebote und Dienstleistungen zu informieren. Die US-Anbieter sind nach dem sog. Privacy-Shield zertifiziert und damit verpflichtet europäischen Datenschutz einzuhalten. Bei der Nutzung und dem Aufruf unseres Profils im jeweiligen Netzwerk durch Sie gelten die jeweiligen Datenschutzhinweise und Nutzungsbedingungen des jeweiligen Netzwerks.
                        <br>
                        <br> </li>
                    <li>Wir verarbeiten Ihre Daten, die Sie uns über diese Netzwerke senden, um mit Ihnen zu kommunizieren und um Ihre dortigen Nachrichten zu beantworten.
                        <br>
                        <br> </li>
                    ...
                    <li>Die Datenschutzhinweise, Auskunftsmöglichkeiten und Widerspruchmöglichkeiten (Opt-Out) der jeweiligen Netzwerke finden Sie hier:
                        <br>
                        <br>• <strong>Instagram</strong> (Instagram Inc., 1601 Willow Road, Menlo Park, CA, 94025, USA) – Datenschutzerklärung/ Opt-Out: <a href="http://instagram.com/about/legal/privacy/" rel="nofollow" target="_blank">http://instagram.com/about/legal/privacy/</a>.
                        <br>
                        <br> </li>
                </ol>
                <br> <strong>Rechte der betroffenen Person</strong>
                <ol style="margin:0px 10px; padding:15px;">
                    <li><strong>Widerspruch oder Widerruf gegen die Verarbeitung Ihrer Daten<br><br>
						...
						Sie können der Verarbeitung Ihrer personenbezogenen Daten für Zwecke der Werbung und Datenanalyse jederzeit widersprechen. Das Widerspruchsrecht können Sie kostenfrei ausüben. Über Ihren Werbewiderspruch können Sie uns unter folgenden Kontaktdaten informieren:<br><br>Felix Buhler<br>Reichenberger Str. 140<br>10999 Berlin, Deutschland<br>E-Mail-Adresse: hi@felix-buhler.de<br></strong>
                        <br> </li>
                ...
                <br> <strong>Datensicherheit</strong>
                ...
                <br>
                <br> <strong>Stand: 11.12.2019</strong>
                <p>Quelle: <a href="https://www.juraforum.de/datenschutzerklaerung-muster/">Datenschutzerklärung DSGVO Muster von Juraforum.de</a></p>
            </text>
        </content-panel>
        <helper clear></helper>
    </main>
    <!-- Footer -->
    <footer padding-border>&copy; 2021 <a title="Shop" href="https://www.shop.felix-buhler.de">Shop</a><a title="Write me an eMail" href="mailmailmail.php">Mail</a><a title="@felixbuhler on Instagram" href="http://instagram.com/felixbuhler/">Instagram</a><a title="Imprint" href="imprint">Imprint & Privacy</a></footer>
    <!-- SCRIPT -->
    ...
    <script>
        ...
        $('.checkcheck').click(function () {
            this.checked ? $('img.thumb').show(500) : $('img.thumb').hide(500); //time for show
